  ...
  <li class="nav-item {{ active('book', 'active', 'group') }}">
    ...
    <div id="book" class="collapse {{ active('book', 'show', 'group') }}">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item {{ active('book/create', 'active') }}" href="{{ route('book.create') }}">Add Buku</a>
      </div>
    </div>
  </li>
  ...
  <li class="nav-item {{ active('stock', 'active', 'group') }}">
    ...
    <div id="stock" class="collapse {{ active('stock', 'show', 'group') }}">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item {{ active('stock/add', 'active') }}" href="{{ route('stock.add') }}">Add Stok</a>
        <a class="collapse-item {{ active('stock/remove', 'active') }}" href="{{ route('stock.remove') }}">Remove Stok</a>
      </div>
    </div>
  </li>
  ...
  <li class="nav-item {{ active('loan', 'active', 'group') }}">
    ...
    <div id="loan" class="collapse {{ active('loan', 'show', 'group') }}">
      <div class="bg-white py-2 collapse-inner rounded">
        ...
        <a class="collapse-item {{ active('loan', 'active') }}" href="{{ route('loan.index') }}">Data Pinjaman</a>
        <a class="collapse-item {{ active('loan/create', 'active') }}" href="{{ route('loan.create') }}">Add Pinjaman</a>
      </div>
    </div>
  </li>
